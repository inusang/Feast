...
public class MilkRefineMachineGuiContainer extends ContainerScreen<MilkRefineMachineContainer> {
	...
	public MilkRefineMachineGuiContainer(MilkRefineMachineContainer container,PlayerInventory pi,ITextComponent title) {
