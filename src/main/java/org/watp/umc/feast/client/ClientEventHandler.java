...
import org.watp.umc.feast.client.gui.MilkRefineMachineGuiContainer;
...
public class ClientEventHandler {
	...
	private static class EventHandlers {
		...
		public static void registerClientGuiFactories(final FMLClientSetupEvent event) {
			...
			ScreenManager.registerFactory(ContainerTypeRegistry.containerMilkRefineMachine.get(),MilkRefineMachineGuiContainer::new);
		}
	}
}
